...
اگر دقیق نگاه کنید، متوجه میشوید که میتوان هر سطر را به قسمت کرد:
1. قسمت فاصله ها (هر سطر متفاوت)
2. قسمت `*` ها (هر سطر ثابت)

خب قسمت اول متغیر است و تعداد آن ها را میتوان از رابطه `n-1-y`.
قسمت دوم نیز ثابت و برابر با `n`.
